...
function ItemGroup({ className, ...props }) {
  return (
    <div role="list" data-slot="item-group" className={cn("group/item-group flex w-full flex-col gap-4", className)} {...props} />
  )
}
...
function ItemDescription({ className, ...props }) {
  return <p data-slot="item-description" className={cn("line-clamp-2 text-left text-sm leading-normal text-muted-foreground", className)} {...props} />
}
