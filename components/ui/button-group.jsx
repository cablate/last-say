...
function ButtonGroupText({ className, asChild = false, ...props }) {
  ...
  return <Comp className={cn("flex items-center gap-2 rounded-lg border bg-muted px-2.5 text-sm font-medium", className)} {...props} />
}

function ButtonGroupSeparator({ className, orientation = "vertical", ...props }) {
  return <Separator data-slot="button-group-separator" orientation={orientation} className={cn("relative self-stretch bg-input", className)} {...props} />
}
